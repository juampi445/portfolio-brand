  ...
  return (
    <section id="services" className={styles.services}>
      <div className={styles.inner}>
        ...
        {/* Right: each service as a full card that pins and stacks as you scroll
          ...
          {SERVICE_IDS.map((id) => {
            ...
            return (
              <ScrollStackItem key={id} itemClassName={styles.card}>
                {/* Identity rail: the service's mark, a glance-line, and when it
                    ships. A hairline (in the stylesheet) divides it from the
                    offer — a rule, not a box. */}
